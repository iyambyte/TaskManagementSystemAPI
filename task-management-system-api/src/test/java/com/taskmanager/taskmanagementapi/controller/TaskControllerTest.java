package com.taskmanager.taskmanagementapi.controller;
...
import com.taskmanager.taskmanagementapi.service.TaskService;
...
class TaskControllerTest {
    ...
    void testGetTaskNotFound() throws Exception {
        when(taskService.getTaskById("non-existent"))
                .thenThrow(new com.taskmanager.taskmanagementapi.exception.ResourceNotFoundException(
    ...
    void testDeleteNonExistentTask() throws Exception {
        doThrow(new com.taskmanager.taskmanagementapi.exception.ResourceNotFoundException(
                "Task not found with id: non-existent"))
    ...
    void testGetAllTasksInvalidPagination() throws Exception {
        when(taskService.getAllTasks(-1, 10, null))
                .thenThrow(new com.taskmanager.taskmanagementapi.exception.ValidationException(
